...
const technologies = [
  {
    ...
    description: "Advanced firewall configurations, intrusion detection systems, and network monitoring tools to protect your organizational infrastructure.",
  ...
  },
  {
    ...
    description: "Comprehensive solutions for controlling user access to critical systems and sensitive data across your organization.",
  ...
  },
  {
    ...
    description: "Securing cloud environments and workloads with specialized tools and configurations for major cloud providers.",
    tools: ["AWS Security Hub", "Azure Sentinel", "Google Cloud Security", "CloudGuard"],
    image: "https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=700&q=80"
  },
  {
    icon: <Cpu className="h-10 w-10 text-cyber-red" />,
    title: "Endpoint Protection",
    description: "Next-generation antivirus and endpoint detection and response (EDR) solutions to secure all devices in your network.",
    tools: ["CrowdStrike", "SentinelOne", "Carbon Black", "Trend Micro"],
    image: "https://images.unsplash.com/photo-1588508065123-287b28e013da?w=700&q=80"
  },
  {
    icon: <Code className="h-10 w-10 text-cyber-red" />,
    title: "Application Security",
    description: "Securing software development lifecycles and implementing robust application vulnerability management.",
  ...
  },
  {
    ...
    description: "Comprehensive data encryption, access controls, and data loss prevention strategies for sensitive information.",
      ...
      <div className="container mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
            ...
            exceptional cybersecurity and technical solutions to our clients.
          </p>
        </div>
              ...
              <CardContent>
                ...
                <div className="flex flex-wrap gap-2">
                  {tech.tools.map((tool, i) => (
                    <span key={i} className="bg-secondary text-foreground/80 px-3 py-1 text-sm rounded-full">
                      {tool}
                    </span>
                  ))}
                </div>
