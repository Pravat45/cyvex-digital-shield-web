...
const testimonials = [
  {
    ...
    message:
      "Cyvex Lab gave me the opportunity to work on advanced security systems. The team is collaborative and the work is meaningful!",
  ...
  },
  {
    ...
    message:
      "I love connecting consultants with innovative healthcare projects. Cyvex's vision makes a real difference.",
...
export default function Career() {
  ...
  const handleJobPrev = () =>
    setCurrentJob((prev) => (prev - 1 + jobs.length) % jobs.length);
      ...
      <div className="section-padding min-h-screen bg-gradient-to-br from-secondary to-background">
        <div className="container mx-auto max-w-5xl">
          <header className="mb-10 flex flex-col md:flex-row items-center gap-8">
            <div className="flex-1">
              ...
              <p className="text-lg text-muted-foreground mb-3">
                Join our team of passionate professionals redefining the future
                of cybersecurity and technology staffing.
              </p>
          ...
          <section className="mt-16">
            <h2 className="text-2xl font-bold mt-2 mb-8 text-center">
              Why Join Cyvex Lab?
            </h2>
            <div className="flex flex-col md:flex-row gap-8 justify-center items-stretch">
              {testimonials.map((testimonial) => (
                <Card
                  ...
                  className="flex-1 flex flex-col items-center p-6 shadow-lg glass"
                >
                  <img
                  ...
                  <div className="text-center text-foreground/80 mb-1">
                    "{testimonial.message}"
                  </div>
                  <div className="flex gap-1">
                    {Array(5)
                      .fill(0)
                      .map((_, i) => (
                        <span key={i} className="text-cyber-red">
                          &#9733;
                        </span>
                      ))}
                  </div>
