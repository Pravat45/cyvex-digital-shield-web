...
const blogPosts = [
  {
    ...
    excerpt:
      "Exploring emerging threats and defense mechanisms as remote work becomes the new normal for enterprise organizations.",
    date: "April 15, 2025",
  ...
  },
  {
    ...
    excerpt:
      "The unique challenges of recruiting for healthcare IT positions and strategies for building effective teams.",
    date: "April 10, 2025",
    author: "Michael Chen",
    category: "Healthcare",
    image:
  ...
  },
  {
    ...
    excerpt:
      "A comprehensive approach to securing sensitive government information in an increasingly complex threat landscape.",
    date: "April 5, 2025",
    author: "David Wilson",
    category: "Government",
    image:
  ...
  },
  {
    ...
    excerpt:
      "Analysis of hiring trends and the technical skills that will command premium salaries in the coming year.",
    date: "March 28, 2025",
    author: "Jennifer Lee",
    category: "Staffing",
    image:
      "https://images.unsplash.com/photo-1487058792275-0ad4aaf24ca7?w=700&q=80",
  },
  {
    title: "Securing the Modern API Ecosystem",
    excerpt:
      "Best practices for implementing robust API security in your organization's software development lifecycle.",
    date: "March 20, 2025",
    author: "Robert Kumar",
  ...
  },
  {
    ...
    excerpt:
      "Key considerations for establishing and managing effective SOCs that can adapt to evolving threat landscapes.",
    date: "March 15, 2025",
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Insights, thought leadership, and industry trends from our experts
              in cybersecurity, healthcare IT, staffing, and software
              development.
            </p>
          </div>
        </div>
          ...
          <Card className="overflow-hidden lg:flex">
            ...
            <div className="lg:w-1/2 flex flex-col justify-center p-6 lg:p-8">
              ...
              <p className="text-muted-foreground mb-6">
                ...
                transforming cybersecurity practices, creating both new
                defensive capabilities and potential vulnerabilities.
              </p>
