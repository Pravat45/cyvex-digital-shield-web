...
const images = [
  "/placeholder.svg", // Placeholder image (will be replaced with actual images)
  "/placeholder.svg",
  "/placeholder.svg"
];
        ...
        <div className="container mx-auto px-4 md:px-6 text-center text-white">
          <div className="max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Button size="lg" className="bg-cyber-red hover:bg-cyber-red/90 text-white rounded-full px-8">
